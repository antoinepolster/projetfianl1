...
J'ai divisé mon programme en 2 fichiers: __joueur.py__, gére en grande partie la communication avec le serveur et __gridutils.py__, qui comprennd toute les fonction n'ont aucun rapport avec le réseau. J'ai fait cela pour pouvoir faire plus facilement mes tests unitaires et pour que ça soit plus facile au niveau méthode de travail
